...
class Calendar2Test extends Calendar1 {

    public static void main(String[] args) {

        try {

            File Appointmenttextfile = new File ("c:\\users\\rahul\\Appointment-Calendar\\target\\B.txt");

            Scanner scan = new Scanner(Appointmenttextfile);

            OutputStream Appointmenthtmlfile= new FileOutputStream(new File("c:\\users\\rahul\\Appointment-Calendar\\target\\appointment2.html"));
            ...
            htmlheader+="<title>APPOINTMENT CALENDAR</title>";
